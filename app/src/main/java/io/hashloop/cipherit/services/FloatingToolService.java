package io.hashloop.cipherit.services;
...
import io.hashloop.cipherit.activities.MainActivity;
...
/**
 * This foreground service is an implementation of main CipherITView because has the same functionality
 * but in another way (floating tool). It uses the same presenter.
 */
public class FloatingToolService extends Service implements CipherITView {
    ...
    private @CipherITView.Mode int mode;
