...
import io.hashloop.cipherit.utils.PreferencesUtils;

public class CipherITModelImpl implements CipherITModel {

    private final static String ENCRYPTION_THREAD_NAME = "io.hashloop.cipherit.thread.encryption";
    ...
    public CipherITModelImpl(Context context) {
    ...
    @Override
    public void onDestroy(@CipherITView.Mode int lastMode,
