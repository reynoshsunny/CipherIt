...
public class ClipboardUtils {
    ...
    public static void copyText(Context context, String text, @CipherITView.Mode int mode, @Nullable View rootView) {
        if (TextUtils.isEmpty(text)) {
            ...
            String label = context.getString(mode == CipherITView.Mode.ENCRYIPT_MODE ? R.string.plain_text_label : R.string.encrypted_text_label);
