...
public class PreferencesUtils {
    ...
    private static final String PREFS_KEY = "cipherIt_preferences";

    private static final String LAST_MODE_KEY = "last_mode";
    private static final @CipherITView.Mode int LAST_MODE_DEFAULT = CipherITView.Mode.ENCRYIPT_MODE;
    ...
    public static @CipherITView.Mode int getLastMode(Context context) {
        ...
        return lastModeRaw == CipherITView.Mode.DECRYIPT_MODE ? CipherITView.Mode.DECRYIPT_MODE : CipherITView.Mode.ENCRYIPT_MODE;
    }

    public static void setLastMode(Context context, @CipherITView.Mode int mode) {
        SharedPreferences prefs = context.getSharedPreferences(PREFS_KEY, MODE_PRIVATE);
